...
export class Dialog<B extends Bot<any, { id: string }>> {
   ...
   * @param {B}      public bot  instance of the xene bot to which a dialog belongs to
   * @param {string} public chat a chat id
   */
   ...
   * dialog's lifecycle.
   * @param {B['_']['Message']} message bot message
   */
  onOutgoingMessage(message: B['_']['Message']): void {
    /* implemented in a subclass */
  }
   ...
   *
   * @param {B['_']['Message']} message result of `Bot#sendMessage()`
   */
